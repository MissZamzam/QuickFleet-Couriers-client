...
<footer class="p-4 mt-24 sm:p-6 dark:bg-gray-900 footerback">
    <div class="md:flex md:justify-between">
        ...
        <div class="grid mx-12 grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                <li class="mb-4">
                <h2 class="mb-6 text-sm font-semibold text-white-900 uppercase dark:text-white">Get In Touch</h2>
                    </li>
                    <li class="mb-4">
                    <p>Nairobi, Kenya<i class="fa fa-map-marker"></i></p>
                    </li>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" class="hover:underline">QuickFleet™</a>. All Rights Reserved.
        </span>
